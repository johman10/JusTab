...
exports.updateServiceSettings = exports.reloadService = exports.loadServices = undefined;

var _mutationTypes = __webpack_require__(8);

var types = _interopRequireWildcard(_mutationTypes);

var _serviceData = __webpack_require__(12);
...
var reloadService = exports.reloadService = function reloadService(_ref2, _ref3) {
  ...
  return serviceData[service.functionName]().then(function (service) {
    commit(types.RELOAD_SERVICE, { service: service });
  });
};

// Save the changes to chrome storage
var updateServiceSettings = exports.updateServiceSettings = function updateServiceSettings(_ref4, _ref5) {
  ...
  chrome.storage.sync.set(changes, function () {
    chrome.runtime.sendMessage({ name: 'afterUpdateServiceSettings', serviceId: serviceId });
  });
};
...
exports.default = {
  methods: {
    _showRipple: function _showRipple(event) {
      removeAllRipples();
...
function removeAllRipples() {
  var ripples = document.querySelectorAll('.ripple__element');
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-5577404e\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-button.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-5577404e\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-button.scss");
...
module.exports = "data:image/png;base64,"
...
var _vTab = __webpack_require__(68);
...
new _vue2.default({
  ...
  methods: _extends({}, (0, _vuex.mapActions)(['reloadService', 'loadServices']), {
...
var _vButton = __webpack_require__(29);
...
var _vSpinner = __webpack_require__(190);
  ...
  computed: {
    imageObject: function imageObject() {
      return {
        ...
        error: __webpack_require__(42),
        loading: __webpack_require__(42)
      };
    },
    widePanel: function widePanel() {
...
var _vPanelItemButton = __webpack_require__(183);

var _vPanelItemButton2 = _interopRequireDefault(_vPanelItemButton);

var _vPanelItemContent = __webpack_require__(184);

var _vPanelItemContent2 = _interopRequireDefault(_vPanelItemContent);
...
exports.default = {
  components: {
    vPanelItemButton: _vPanelItemButton2.default,
    vPanelItemContent: _vPanelItemContent2.default
  },
...
var _vPanelError = __webpack_require__(180);

var _vPanelError2 = _interopRequireDefault(_vPanelError);

var _vPanelHeader = __webpack_require__(181);

var _vPanelHeader2 = _interopRequireDefault(_vPanelHeader);

var _vPanelSubheader = __webpack_require__(186);

var _vPanelSubheader2 = _interopRequireDefault(_vPanelSubheader);

var _vPanelItem = __webpack_require__(185);

var _vPanelItem2 = _interopRequireDefault(_vPanelItem);

var _vPanelImage = __webpack_require__(182);

var _vPanelImage2 = _interopRequireDefault(_vPanelImage);

var _vServiceActions = __webpack_require__(189);

var _vServiceActions2 = _interopRequireDefault(_vServiceActions);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = {
  components: {
    vPanelError: _vPanelError2.default,
    vPanelHeader: _vPanelHeader2.default,
    vPanelSubheader: _vPanelSubheader2.default,
    vPanelItem: _vPanelItem2.default,
    vPanelImage: _vPanelImage2.default,
    vServiceActions: _vServiceActions2.default
  },
  ...
  computed: _extends({
    ...
    panelContentStyling: function panelContentStyling() {
      return {
    ...
    service: function service(state) {
      ...
      return this.activeServices.find(function (service) {
        return service.id === _this.serviceId;
      });
    }
  }, (0, _vuex.mapGetters)(['activeServices'])),
...
exports.default = {
  ...
  computed: {
    ...
    wrapperStyling: function wrapperStyling() {
      return {
  ...
  methods: {
    openUnread: function openUnread() {
      var _this = this;

      var promises = [];
      this.components.forEach(function (component) {
        var url = component.props.url;
        if (url) promises.push(_this.findHistory(url));
      });
    ...
    findHistory: function findHistory(url) {
...
var _vPanel = __webpack_require__(187);

var _vPanel2 = _interopRequireDefault(_vPanel);

var _vFab = __webpack_require__(178);

var _vFab2 = _interopRequireDefault(_vFab);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-068cd758\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-panel-item.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-068cd758\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-panel-item.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-14feca98\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-panel.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-14feca98\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-panel.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-18f630e6\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-panel-image.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-18f630e6\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-panel-image.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-465c7904\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-panel-item-content.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-465c7904\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-panel-item-content.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-560cfdd8\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-panel-subheader.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-560cfdd8\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-panel-subheader.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-57644adc\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-panel-header.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-57644adc\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-panel-header.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-5ac68af9\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-service-actions.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-5ac68af9\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-service-actions.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-60f23b13\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-panel-error.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-60f23b13\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-panel-error.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-63643dca\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-fab.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-63643dca\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-fab.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-6855512d\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-spinner.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-6855512d\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-spinner.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-85074012\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-panel-item-button.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-85074012\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-panel-item-button.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-9a35c2ae\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-tab.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-9a35c2ae\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/sass-loader/lib/loader.js!./v-tab.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
module.exports = "data:image/svg+xml;base64,"
...
module.exports = "data:image/svg+xml;base64,"
...
Component.options.__file = "/Users/johan/Sites/other/JusTab/components/v-fab.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] v-fab.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-63643dca", Component.options)
  } else {
    hotAPI.reload("data-v-63643dca", Component.options)
  }
})()}
...
Component.options.__file = "/Users/johan/Sites/other/JusTab/components/v-panel-image.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] v-panel-image.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-18f630e6", Component.options)
  } else {
    hotAPI.reload("data-v-18f630e6", Component.options)
  }
})()}
...
Component.options.__file = "/Users/johan/Sites/other/JusTab/components/v-panel-item-content.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] v-panel-item-content.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-465c7904", Component.options)
  } else {
    hotAPI.reload("data-v-465c7904", Component.options)
  }
})()}
...
Component.options.__file = "/Users/johan/Sites/other/JusTab/components/v-panel-subheader.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] v-panel-subheader.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-560cfdd8", Component.options)
  } else {
    hotAPI.reload("data-v-560cfdd8", Component.options)
  }
})()}
...
Component.options.__file = "/Users/johan/Sites/other/JusTab/components/v-service-actions.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] v-service-actions.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5ac68af9", Component.options)
  } else {
    hotAPI.reload("data-v-5ac68af9", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    class: ['panel-item', {
      'panel-item__hover ripple': _vm.hasCollapse || _vm.props.url,
      'panel-item__expanded': _vm.expanded,
      'panel-item__two-lines': _vm.props.subtitle,
      'panel-item__image': _vm.props.image
    }],
    on: {
      "click": _vm.expandItem,
      "mousedown": _vm._showRipple
    }
  }, [_c('div', {
    staticClass: "panel-item--base"
  }, [(_vm.props.url) ? _c('a', {
    staticClass: "panel-item--url",
    attrs: {
      "href": _vm.props.url,
      "target": "_blank"
    }
  }, [_c('v-panel-item-content', {
    attrs: {
      "image": _vm.props.image,
      "has-collapse": _vm.hasCollapse,
      "expanded": _vm.expanded,
      "title": _vm.props.title,
      "subtitle": _vm.props.subtitle,
      "subtitle-url": _vm.props.subtitleUrl,
      "extra-title": _vm.props.extraTitle
    }
  })], 1) : _c('v-panel-item-content', {
    attrs: {
      "image": _vm.props.image,
      "has-collapse": _vm.hasCollapse,
      "expanded": _vm.expanded,
  ...
  })], 1), _vm._v(" "), (_vm.hasCollapse) ? _c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.expanded),
  ...
  }, [_vm._v("\n      " + _vm._s(_vm.props.collapseText) + "\n    ")]), _vm._v(" "), (_vm.props.components) ? _c('div', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    class: ['panel-image', {
      'small-image': _vm.props.smallImages
    }, {
      'wide-panel': _vm.widePanel
    }]
  }, [_c('a', {
    staticClass: "panel-image--link",
    attrs: {
      "href": _vm.props.url,
      "target": "_blank"
    }
  }, [(_vm.props.gif) ? _c('div', {
    staticClass: "panel-image--gif"
  }, [_vm._v("GIF")]) : _vm._e(), _vm._v(" "), _c('div', {
    directives: [{
      name: "lazy",
      rawName: "v-lazy:background-image",
      value: (_vm.imageObject),
      expression: "imageObject",
      arg: "background-image"
    }],
    staticClass: "panel-image--image"
  }), _vm._v(" "), _c('div', {
    staticClass: "panel-image--content"
  }, [_c('div', {
    staticClass: "panel-image--title",
    attrs: {
      "target": "_blank"
    }
  }, [_vm._v("\n        " + _vm._s(_vm.props.title) + "\n      ")]), _vm._v(" "), _c('div', {
    staticClass: "panel-image--subtitle",
    attrs: {
      "target": "_blank"
    }
  }, [_vm._v("\n        " + _vm._s(_vm.props.subTitle) + "\n      ")])])])])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-18f630e6", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "panel-item-content--image"
  }) : _vm._e(), _vm._v(" "), _c('div', {
    staticClass: "panel-item-content--titles"
  }, [_c('div', {
    staticClass: "panel-item-content--title",
    attrs: {
      "title": _vm.title.length > 60 ? _vm.title : ''
    }
  }, [_vm._v("\n      " + _vm._s(_vm.title) + "\n    ")]), _vm._v(" "), (_vm.extraTitle) ? _c('div', {
    staticClass: "panel-item-content--extra-title"
  }, [_vm._v("\n      " + _vm._s(_vm.extraTitle) + "\n    ")]) : (_vm.hasCollapse) ? _c('div', {
    staticClass: "panel-item-content--icon"
  }) : _vm._e(), _vm._v(" "), (_vm.subtitle) ? [_c('div', {
    staticClass: "panel-item-content--subtitle",
    attrs: {
      "title": _vm.subtitle.length > 70 ? _vm.subtitle : ''
    }
  }, [(_vm.subtitleUrl) ? _c('a', {
    staticClass: "panel-item-content--subtitle-url",
    attrs: {
      "href": _vm.subtitleUrl
    }
  }, [_vm._v("\n          " + _vm._s(_vm.subtitle) + "\n        ")]) : [_vm._v("\n          " + _vm._s(_vm.subtitle) + "\n        ")]], 2)] : _vm._e()], 2)])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-465c7904", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-560cfdd8", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "panel-header--foreground-top",
    style: (_vm.foregroundTopStyling)
  }, [_c('div', {
    staticClass: "refresh-button ripple",
    on: {
    ...
    staticClass: "panel-header--foreground-bottom"
  }, [_c('a', {
    staticClass: "panel-header--url",
    attrs: {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "service-actions",
    style: (_vm.wrapperStyling)
  }, [(_vm.service.actions.includes('openUnread')) ? _c('v-button', {
    staticClass: "service-actions--button",
    attrs: {
      "text": "Open unread",
      "type": "flat"
    },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-5ac68af9", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "panel-error-settings-button",
    attrs: {
      "type": "flat",
      "text": "Settings"
    }
  }), _vm._v(" "), _c('v-button', {
    staticClass: "panel-error-retry-button",
    attrs: {
      "type": "flat",
      "text": "Retry"
    },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-63643dca", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "spinner-circular",
    attrs: {
      "viewBox": "25 25 50 50"
    }
  }, [_c('circle', {
    staticClass: "spinner-path",
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('a', {
    staticClass: "ripple panel-item-button",
    attrs: {
      "href": _vm.props.url
    },
    on: {
    ...
    class: ['panel-item-button--icon', _vm.props.iconClass]
  })])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" "), _vm._l((_vm.activeServices), function(service, index) {
    return _c('v-panel', {
      key: service.id,
      attrs: {
