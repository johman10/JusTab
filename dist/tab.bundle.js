...
var _vButton = __webpack_require__(97);
...
var _vPanelItemButton = __webpack_require__(100);

var _vPanelItemButton2 = _interopRequireDefault(_vPanelItemButton);

var _vPanelItemContent = __webpack_require__(101);
...
var _vPanelError = __webpack_require__(98);

var _vPanelError2 = _interopRequireDefault(_vPanelError);

var _vSpinner = __webpack_require__(104);

var _vSpinner2 = _interopRequireDefault(_vSpinner);

var _vPanelHeader = __webpack_require__(99);

var _vPanelHeader2 = _interopRequireDefault(_vPanelHeader);

var _vPanelItem = __webpack_require__(102);
...
exports.default = {
  ...
  data: function data() {
    return {
      loading: false,
      headerHeight: '128px',
      panelHeaderBackgroundOpacity: 1
    };
  },
  ...
  computed: _extends({
    ...
    background2Styling: function background2Styling() {
      return {
        ...
        'opacity': this.panelHeaderBackgroundOpacity
      };
    },
  ...
  methods: {
    onScroll: function onScroll(event) {
      ...
      var panelHeader = panelContent.previousElementSibling;
      var topBar = panelHeader.querySelector('.top');
      var panelBackground = panelHeader.querySelector('.panel-header-background2');
      ...
      if (scrollTop < 64) {
        ...
        this.panelHeaderBackgroundOpacity = opacity;
...
var _vPanel = __webpack_require__(103);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(121)("f4c5a530", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
var _vTab = __webpack_require__(35);
