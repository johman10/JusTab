  ...
  methods: {
    ...
    designerNewsComponents: function designerNewsComponents(data) {
      ...
      data.stories.forEach(function (story) {
        ...
        var badge = story.badge ? __webpack_require__(37)("./badge_" + story.badge + '.png') : false;
...
exports.default = {
  ...
  methods: {
    ...
    gmailComponents: function gmailComponents(emails) {
      ...
      unreadEmails.forEach(function (email) {
        components.push(_this2.buildMailItem(email));
      });
      ...
      readEmails.forEach(function (email) {
        components.push(_this2.buildMailItem(email));
      });
...
var map = {
	...
	"./badge_css.png": 79,
	"./badge_design.png": 80,
	"./badge_discussion.png": 81,
	"./badge_layervault.png": 82,
	"./badge_pinned.png": 83,
	"./badge_podcast.png": 84,
	"./badge_show.png": 85,
	"./badge_sponsored.png": 86,
	"./badge_type.png": 87,
	"./badge_video.png": 88
};
...
var _vCouchPotato = __webpack_require__(27);

var _vCouchPotato2 = _interopRequireDefault(_vCouchPotato);

var _vGmail = __webpack_require__(29);

var _vGmail2 = _interopRequireDefault(_vGmail);

var _vDesignerNews = __webpack_require__(28);
...
window.vueInstance = new _vue2.default({
  ...
  computed: _extends({}, (0, _vuex.mapState)(['services', 'chromePort'])),
  beforeCreate: function beforeCreate() {
    var _this = this;

    this.$store.dispatch('loadServices');
    chrome.runtime.onConnect.addListener(function (port) {
      port.onMessage.addListener(_this.startRefresh);
    });
  },
