...
exports.default = {
  computed: {
    ...
    calendarUrls: function calendarUrls() {
      return this.service.calendars.map(function (url) {
  ...
  methods: {
    ...
    getEvents: function getEvents(token) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var dateEnd = (0, _moment2.default)(new Date()).add(_this.service.days, 'days').endOf('day').toISOString();
        var events = [];
        var promises = [];
        var apiUrl;
    ...
    chrome.runtime.onConnect.addListener(function (port) {
      port.onMessage.addListener(function (msg) {
        if (msg.name === 'startRefresh') {
          var _service = _this.services.find(function (s) {
            return s.id === msg.serviceId;
          });
          _this[_service.functionName]().then(function (data) {
