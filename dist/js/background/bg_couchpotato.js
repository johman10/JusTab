...
function cpCreateVar(movie, cpVar) {
  ...
  cpVar += '<div class="core-item cp-item">' + '<div class="cp-poster-container">' + '<img class="cp-poster" src="img/poster_fallback.png" data-echo="' + posterUrl + '"></img>' + '</div>' + '<div class="core-item-content">' + htmlEncode(movie.title) + '</div>' + '<div class="core-item-icon"></div>' + '</div>' + '<div class="cp-collapse core-collapse">' + '<div class="cp-collapse-date">' + htmlEncode(date) + '</div>' + '<div class="cp-collapse-buttons">' + '<div class="icon-button search-icon cp-search-movie waves-effect" id="' + movie._id + '"></div>' + '<a class="cp-imdb-link" href="http://www.imdb.com/title/' + movie.identifiers.imdb + '" target="_blank">' + '<div class="icon-button info-icon cp-imdb-link-icon waves-effect"></div>' + '</a>' + '</div>' + '</div>';
